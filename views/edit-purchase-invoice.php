...
$db->where("purchase_invoice_id",$invoice_id);
...
<html>
<head>
  <title>Edit Purchase Invoices</title>
  ...
  <div class="container mt-4" style="">
    ...
    <div class="row">
      ...
      if(isset($_POST['save'])){
        ...
        $db->where("id",$invoice_id);
        $db->update('purchase_invoices',$invoice_array); 
        ...
        if (isset($_POST['del_item_id'])) {
          ...
          for ($i=0; $i <$del_count ; $i++) {
            ...
            ReverseTheProductItemForPurchase($del_id[$i],$db);

            $db->where("id",$del_id[$i]);

            $db->delete("purchase_invoice_items");    
        ...
        if (isset($_POST['package_item_id'])) {
          ...
          $pre_old_pro_rate=$_POST['pre_old_package_rate'];
          ...
          for ($i=0; $i < $order_count_pkg; $i++) {
            ...
            if (($old_pro_empty_quantity[$i] != $pre_old_pro_empty_quantity[$i]) || ($old_pro_quantity[$i] != $pre_old_pro_quantity[$i])) {
              ...
              ChangeInProductInvoiceForPurchase($pre_old_pro_empty_quantity[$i],$old_pro_empty_quantity[$i],$pre_old_pro_quantity[$i],$old_pro_quantity[$i],$package_item_id[$i],$old_pro_id[$i],$db);



            }

            if ($old_pro_rate[$i] != $pre_old_pro_rate[$i]) {



              ChangeInProductRateForPurchase($package_item_id[$i],$old_pro_id[$i],$old_pro_rate[$i],$db);
            ...
            $db->update('purchase_invoice_items',$invoice_pkg_arr_old);
        ...
        ?>
        <script>window.location.href="<?php echo baseurl('views/edit-purchase-invoice.php?id='.$invoice_id); ?>"</script>
                      ...
                      <div class="col-sm-12">
                        ...
                        <select  id="ven_name"  name="vendor_id" class="form-control form-control-sm vendor_name" required >
                          ...
                          foreach($vendors as $vendor ){ ?>
                            <option value="<?php echo $vendor['id']; ?>" <?php if($invoice['vendor_id'] == $vendor['id']) echo 'selected'; ?>><?php echo $vendor['name']; ?></option>
                            <?php
                ...
                <div class="table-responsive" >
                  <table class="table table-bordered table-hover" id="normalinvoice">
                    ...
                    <tbody id="addinvoiceItem">
                      ...
                      $detail=$db->get("purchase_invoice_items");
                      ...
                      foreach($detail as $de){ ?>
                        <tr class="invoice-row<?php echo $de['product_id']; ?>">
                          ...
                          <td style="width: 150px;">
                            ...
                            <input name="pre_old_package_rate[]" class=" form-control form-control-sm"  value="<?php echo $de['rate']; ?>" type="hidden">
                          ...
                          <td style="width: 150px;">
                            ...
                            <input name="old_package_rate[]" value="<?php echo $de['rate']; ?>" id="item_price_<?php echo $de['product_id']; ?>" class=" price_item form-control form-control-sm" tabindex="7" onkeyup="quantity_calculate(<?php echo $de['product_id']; ?>);" type="text">
                    ...
                    <tfoot>
                      ...
                      <tr>
                        ...
                        <td class="text-right" colspan="2">
                          <input id="paidAmount" autocomplete="off" class="form-control form-control-sm" name="paid_amount" onkeyup="invoice_paidamount();" value="<?php echo $invoice['paid']; ?>" placeholder="0.00" tabindex="7" type="number">
                        </td>
                      </tr>
                      <tr>                               
